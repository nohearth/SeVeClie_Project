...
CREATE DATABASE [VeClient]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'VeClient', FILENAME = N'C:\Users\simon\VeClient.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'VeClient_log', FILENAME = N'C:\Users\simon\VeClient_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
